        ...
        if (!PopulationList.isEmpty()) {
            for (int i = 0; i < PopulationList.size(); i++) {
                if (PopulationList.get(i).get("upload_status").equals("1")) {
                    ...
                    temp.put("congh6", CongList.get(0).get("congh6"));
                    temp.put("congh7", CongList.get(0).get("congh7"));
                    temp.put("congh8", CongList.get(0).get("congh8"));
                    temp.put("congh9", CongList.get(0).get("congh9"));
                    temp.put("congh10", CongList.get(0).get("congh10"));
                    temp.put("congh11", CongList.get(0).get("congh11"));
                    temp.put("congh12", CongList.get(0).get("congh12"));
                    temp.put("congh13", CongList.get(0).get("congh13"));
                    temp.put("congh14", CongList.get(0).get("congh14"));
                    temp.put("congh15", CongList.get(0).get("congh15"));
                    temp.put("congh16", CongList.get(0).get("congh16"));
                    temp.put("congh17", CongList.get(0).get("congh17"));
                    temp.put("congh18", CongList.get(0).get("congh18"));
                    temp.put("congh19", CongList.get(0).get("congh19"));
                    temp.put("congh20", CongList.get(0).get("congh20"));
                    temp.put("congh21", CongList.get(0).get("congh21"));
                    temp.put("congh22", CongList.get(0).get("congh22"));
                    temp.put("congh23", CongList.get(0).get("congh23"));
                    temp.put("congh24", CongList.get(0).get("congh24"));
                    temp.put("congh25", CongList.get(0).get("congh25"));
                    temp.put("congh26", CongList.get(0).get("congh26"));
                    ...
                    temp.put("conth12", ContList.get(0).get("conth12"));
                    temp.put("conth13", ContList.get(0).get("conth13"));
                    temp.put("conth14", ContList.get(0).get("conth14"));
                    temp.put("conth15", ContList.get(0).get("conth15"));
                    temp.put("conth16", ContList.get(0).get("conth16"));
                    temp.put("conth17", ContList.get(0).get("conth17"));
                    temp.put("conth18", ContList.get(0).get("conth18"));
                    temp.put("conth19", ContList.get(0).get("conth19"));
                    temp.put("conth20", ContList.get(0).get("conth20"));
                    temp.put("conth21", ContList.get(0).get("conth21"));
                    temp.put("conth22", ContList.get(0).get("conth22"));
                    temp.put("conth23", ContList.get(0).get("conth23"));
                    temp.put("conth24", ContList.get(0).get("conth24"));
                    temp.put("conth25", ContList.get(0).get("conth25"));
                    temp.put("conth26", ContList.get(0).get("conth26"));
                    temp.put("conth27", ContList.get(0).get("conth27"));
                    temp.put("conth28", ContList.get(0).get("conth28"));
                    temp.put("conth29", ContList.get(0).get("conth29"));
                    temp.put("conth30", ContList.get(0).get("conth30"));
                    temp.put("conth31", ContList.get(0).get("conth31"));
                    temp.put("conth32", ContList.get(0).get("conth32"));
                    temp.put("conth33", ContList.get(0).get("conth33"));
                    temp.put("conth34", ContList.get(0).get("conth34"));
                    temp.put("conth35", ContList.get(0).get("conth35"));
                    temp.put("conth36", ContList.get(0).get("conth36"));
                    temp.put("conth37", ContList.get(0).get("conth37"));
                    temp.put("conth38", ContList.get(0).get("conth38"));
                    temp.put("conth39", ContList.get(0).get("conth39"));
                    temp.put("conth40", ContList.get(0).get("conth40"));
                    temp.put("conth41", ContList.get(0).get("conth41"));
                    temp.put("conth42", ContList.get(0).get("conth42"));
                    temp.put("conth43", ContList.get(0).get("conth43"));
                    temp.put("conth44", ContList.get(0).get("conth44"));
                    temp.put("conth45", ContList.get(0).get("conth45"));
                    temp.put("conth46", ContList.get(0).get("conth46"));
                    temp.put("conth47", ContList.get(0).get("conth47"));
                    temp.put("conth48", ContList.get(0).get("conth48"));
                    temp.put("conth49", ContList.get(0).get("conth49"));
                    temp.put("conth50", ContList.get(0).get("conth50"));
                    temp.put("conth51", ContList.get(0).get("conth51"));
